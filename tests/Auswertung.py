...
# Read in an image
img = cv.imread('testimages\img5286.png')
#cv.imshow('Park', img)
...
# Blur 
blur = cv.GaussianBlur(rotated, (7,7), cv.BORDER_DEFAULT)

#cropped
cropped_image = blur[200:500 ,400:1000] # Slicing to crop the image
...
# lines = lsd.detect(cropped_image)[0] #Position 0 of the returned tuple are the detected lines
# #Draw detected lines in the image
# drawn_img = lsd.drawSegments(cropped_image,lines)
# cv.imshow("Source", drawn_img)
